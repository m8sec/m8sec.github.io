...
date: "2023-08-10"
tags: ["Posts", "reversing", "game hacking"]
draft: false
---
...
Using the two `.sav` files, I use the `hexdump` and `diff` commands to identify differences between the files. With each file being exactly alike, the cash values `3000` vs `3175` should stand out.
...
At this point, I was excited to resume the game and see the new cash mount under my player’s profile. However, instead, the game indicated the save state was corrupt or destroyed ☠️
